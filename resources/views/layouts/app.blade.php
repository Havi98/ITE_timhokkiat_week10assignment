...
<html lang="en">
    <head>
        ...
        <title>@yeild('title')- Confession</title>
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark navbar-custom fixed-top">
            <div class="container px-5">
                <a class="navbar-brand" href="#page-top">Confession</a>
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item"><a class="nav-link" href="{{route('users.do_login')}}">Log In</a></li>
                        <li class="nav-item"><a class="nav-link" href="{{route('users.do_register')}}">Sign Up</a></li>
                    </ul>
                </div>
            </div>
        </nav>
